...
extern "C" {
     ...
     */
    extern void GetQQGroupCodeV2(unsigned char* guildId,unsigned char* zoneI);
    ...
    extern void RemindGuildLeaderV2(unsigned char * guildId,unsigned char * zoneId, unsigned char * roleId, unsigned char * roleName,
                                    unsigned char * partition,unsigned char * userZoneId, unsigned char * type, unsigned char * leaderOpenId,
                                    unsigned char * leaderRoleId, unsigned char * leaderZoneId,unsigned char* areaId);
    extern void BindExistQQGroupV2(unsigned char* groupId ,unsigned char* groupName,unsigned char* guildId,
                            unsigned char *zoneId,unsigned char *roleId);
     ...
     *
     */
    extern void CreateQQGroupV2(unsigned char*guildId,unsigned char*guildName,unsigned char* zoneId,unsigned char* roleId,unsigned char* partition);
     ...
     *
     */
    extern void JoinQQGroupV2(unsigned char* guildId, unsigned char* zoneId,unsigned char* groupId, unsigned char* roleId, unsigned char* partition);
     ...
     *
     */
    extern void UnbindQQGroupV2(unsigned char* guildId,unsigned char* guildName,unsigned char* zoneId);
